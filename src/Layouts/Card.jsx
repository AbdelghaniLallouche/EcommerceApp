...
const Card = () => {
  ...
  return (
    <div className="mx-5 mt-3">
      <h1 className="txt mb-3">Mon Panier</h1>
      <div className="w-full flex md:flex-row flex-col gap-5 justify-start items-center">
        ...
        <div className="sm:grid hidden w-full sm:justify-center sm:content-center sm:justify-items-center sm:items-center sm:grid-cols-5">
          ...
          {cart.map((item) => (
            ...
            <div
              ...
              flex flex-row justify-between items-center gap-2 bg-[#D9D9D9] bg-opacity-60 pr-2 rounded-xl
              "
            >
          ...
          <div className="md:w-[25%] w-full flex flex-col justify-start items-center">
            <div className="bg-[#D9D9D9] flex flex-col justify-start items-center gap-5 my-2 p-4 w-full">
            ...
            className="uppercase text-white w-full bg-black rounded-3xl pt-1 pb-2">
                Commander
            </button>
          </div>
