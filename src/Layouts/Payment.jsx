...
const Payment = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col gap-4 mt-1 justify-start items-center">
      <div className="w-full bg-white p-4">
        <h1 className="txt">ADRESS CLIENT</h1>
        <div className="grid grid-cols-2 w-full gap-3 mt-1 justify-center items-center justify-items-center">
          <input
            type="text"
            placeholder="NOM*"
            className="inputt"
        ...
        <div>
          <h1 className="txt my-2">DÉTAILS DE LIVRAISON</h1>
          <div className="flex flex-row gap-2 items-center mb-2 justify-start">
            ...
            <div className="p-4 bg-[#D9D9D9] w-full  flex flex-col gap-2">
            ...
            <button className="text-white font-semibold bg-black px-8 text-sm rounded-xl pt-1 pb-2 w-full md:w-[300px] uppercase mt-3">Confirmer la commande</button>
            </div>
    </div>
  );
};
