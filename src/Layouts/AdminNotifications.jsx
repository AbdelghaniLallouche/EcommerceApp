    ...
    return ( 
        ...
        <div>
            {notifications.map((notification) => (
                <div key={notification.id} className="flex lil:flex-row flex-col my-1 py-1 px-2 shadow-md bg-white border-[1px] rounded-xl gap-8 w-full items-center justify-start">
                    <img
