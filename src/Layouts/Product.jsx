...
const Product = () => {
    ...
    reviews: 200,
    taille : ["S","M","L","XL"],
    images : ["../src/Pics/a.jpg","../src/Pics/a.jpg","../src/Pics/wol.jpg" , "../src/Pics/a.jpg"]
    }); //product object

    const [quantity, setQuantity] = useState(1); //quantity of product

  return (
  <div className="mx-4 mt-2 w-calc(100% - 32px) flex md:flex-row flex-col gap-5 items-start justify-start bg-white p-4 shadow-lg border-y-[1px]">

    {/* div for images */}
    <div className="flex flex-col gap-2 justify-start items-start">
    <div className="w-full gg:h-[400px] h-[300px] grid grid-cols-2 gg:grid-cols-3 gg:grid-rows-3 gap-2 justify-start items-center">
        {
      ...
      <div className="flex flex-col gap-2 items-start justify-start">{
        reviews.map((review)=>(
          <div className="flex gap-[5px] shadow-md w-full p-2 rounded-md items-start bg-gray-400 bg-opacity-10">
            <img src={review.pic} className="w-[50px] h-[50px] rounded-full" alt=""/>
    ...
    <div className="w-full justify-between h-[350px] items-start flex flex-col gap-2 mt-4">
      ...
      <div className="flex flex-row bg-gray-500 bg-opacity-60 gap-3 rounded-3xl items-center px-3 pt-1 pb-2">
                <button onClick={()=>{
        ...
        <button className="text-white uppercase bg-black px-8 pb-[2px] w-full rounded-xl">Ajouter au panier</button>
      </div>
    </div>
